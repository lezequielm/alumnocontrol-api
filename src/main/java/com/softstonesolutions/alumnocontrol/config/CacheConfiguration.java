package com.softstonesolutions.alumnocontrol.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.softstonesolutions.alumnocontrol.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.softstonesolutions.alumnocontrol.repository.UserRepository.USERS_BY_EMAIL_CACHE);
