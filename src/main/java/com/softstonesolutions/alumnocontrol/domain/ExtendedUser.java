...
public class ExtendedUser implements Serializable {
    ...
    public ExtendedUser addresses(Set<Address> addresses) {
        this.addresses = addresses;
        return this;
    }

    public ExtendedUser addAddresses(Address address) {
        this.addresses.add(address);
        address.setUser(this);
        return this;
    }

    public ExtendedUser removeAddresses(Address address) {
