...
public class Student implements Serializable {
    ...
    public Student asistences(Set<Asistence> asistences) {
        this.asistences = asistences;
        return this;
    }

    public Student addAsistence(Asistence asistence) {
        this.asistences.add(asistence);
        asistence.setStudent(this);
        return this;
    }

    public Student removeAsistence(Asistence asistence) {
        this.asistences.remove(asistence);
        asistence.setStudent(null);
        return this;
    }
