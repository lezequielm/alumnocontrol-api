          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('flat')}>
                  Flat <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {addressList.map((address, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{address.order}</td>
                  <td>{address.user ? <Link to={`extended-user/${address.user.id}`}>{address.user.id}</Link> : ''}</td>
                  <td>{address.student ? <Link to={`student/${address.student.id}`}>{address.student.id}</Link> : ''}</td>
