            ...
            <tbody>
              {contactList.map((contact, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{contact.data}</td>
                  <td>{contact.order}</td>
                  <td>{contact.student ? <Link to={`student/${contact.student.id}`}>{contact.student.id}</Link> : ''}</td>
                  <td>{contact.user ? <Link to={`extended-user/${contact.user.id}`}>{contact.user.id}</Link> : ''}</td>
