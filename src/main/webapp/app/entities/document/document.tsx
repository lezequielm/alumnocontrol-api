            ...
            <tbody>
              {documentList.map((document, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{document.name}</td>
                  <td>{document.requestDate ? <TextFormat type="date" value={document.requestDate} format={APP_DATE_FORMAT} /> : null}</td>
                  ...
                  <td>{document.sent ? 'true' : 'false'}</td>
                  <td>{document.group ? <Link to={`group/${document.group.id}`}>{document.group.name}</Link> : ''}</td>
                  <td>{document.student ? <Link to={`student/${document.student.id}`}>{document.student.id}</Link> : ''}</td>
